$(function(){
    ...
    $('.log').mouseover(function(){
        $('.log').addClass('log1')
        $('.log img').attr('src', '../img/eef283b0ed619fe4.gif')
    }).mouseleave(function(){
        $('.log').removeClass('log1')
        setTimeout(()=>{
            $('.log img').attr('src', 'https://img10.360buyimg.com/img/jfs/t1/192028/25/33459/5661/63fc2af2F1f6ae1b6/d0e4fdc2f126cbf5.png')
        }, 1000) 
    })
   ...
   setInterval(countDown, 1000)
    function countDown() {
    var date = new Date('2023-03-20 19:00:00')
...
//      fn()
    ...
    let page = 1
    let listType = 'hot'
    goodListFun(page , listType)

    //点击li
    $('.five .iii .ili').on('click',function(){
        page = 1
    ...
    function goodListFun(page1 ,type){
        axios.post('http://127.0.0.1:3000/goodlist',{
            page : page1,
            type : type
        }).then(res => {
    ...
    //         $(this).children('p').addClass('on').parent().siblings().children('p').removeClass('on')
    //     })
   ...
   $('.five .iii .ili').mouseover(function(){
    ...
    $('.iii li').click(function(){
        $(this).children('p').addClass('on').parent().siblings().children('p').removeClass('on')
        $(this).children('span').addClass('color').parent().siblings().children('span').removeClass('color')
    })
